      ...
      <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
          ...
          <div class="alert alert-danger alert-dismissible show fade">
           ...
           @endif
        <button  wire:click='addgroupd()'>{{$value}}</button>
          <!-- end of alert -->
          <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-form">
                    ...
                    <div class="input-group">
                      <h4><button class="btn btn-primary" >Add new Group<i class="fa fa-plus"></i></button></h4>
                    </div>
                        ...
                        <table class="table table-striped table-md">
                          ...
                          @foreach($group ?? '' as $glist)
                            ...
                            <td>
                              ...
                              <button  wire:click="destroy({{$glist->id}})" ><i class="fas fa-trash-alt"></i></button>
